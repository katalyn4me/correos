...
class DATOSDESTINATARIOMODIFTYPE extends AbstractStructBase
{
     ...
     * @param \StructType\IDENTIFICACIONTYPE $identificacion
     * @return \StructType\DATOSDESTINATARIOMODIFTYPE
     */
