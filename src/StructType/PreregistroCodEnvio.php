...
/**
 * This class stands for PreregistroCodEnvio StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class PreregistroCodEnvio extends AbstractStructBase
{
    /**
     * The FechaOperacion
    ...
    /**
     * Constructor method for PreregistroCodEnvio
     * @uses PreregistroCodEnvio::setFechaOperacion()
     * @uses PreregistroCodEnvio::setCodEtiquetador()
     * @uses PreregistroCodEnvio::setNumContrato()
     * @uses PreregistroCodEnvio::setNumCliente()
     * @uses PreregistroCodEnvio::setCare()
     * @uses PreregistroCodEnvio::setTotalBultos()
     * @uses PreregistroCodEnvio::setModDevEtiqueta()
     * @uses PreregistroCodEnvio::setRemitente()
     * @uses PreregistroCodEnvio::setDestinatario()
     * @uses PreregistroCodEnvio::setEnvio()
     * @uses PreregistroCodEnvio::setEntregaParcial()
     * @uses PreregistroCodEnvio::setCodExpedicion()
     * @uses PreregistroCodEnvio::setIdiomaErrores()
     ...
     * @param string $fechaOperacion
     * @return \StructType\PreregistroCodEnvio
     */
