...
/**
 * This class stands for PreregistroCodExpedicion StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class PreregistroCodExpedicion extends AbstractStructBase
{
    /**
     * The FechaOperacion
     ...
     * @uses PreregistroCodExpedicion::setFechaOperacion()
     * @uses PreregistroCodExpedicion::setCodEtiquetador()
     * @uses PreregistroCodExpedicion::setNumContrato()
     * @uses PreregistroCodExpedicion::setNumCliente()
     * @uses PreregistroCodExpedicion::setCare()
     * @uses PreregistroCodExpedicion::setTotalBultos()
     * @uses PreregistroCodExpedicion::setModDevEtiqueta()
     * @uses PreregistroCodExpedicion::setRemitente()
     * @uses PreregistroCodExpedicion::setDestinatario()
     * @uses PreregistroCodExpedicion::setEnvio()
     * @uses PreregistroCodExpedicion::setEntregaParcial()
     * @uses PreregistroCodExpedicion::setCodExpedicion()
     * @uses PreregistroCodExpedicion::setIdiomaErrores()
     ...
     * @param string $fechaOperacion
     * @return \StructType\PreregistroCodExpedicion
     */
