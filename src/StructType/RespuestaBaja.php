...
/**
 * This class stands for RespuestaBaja StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class RespuestaBaja extends AbstractStructBase
{
    /**
     * The FechaRespuesta
     ...
     * @uses RespuestaBaja::setFechaRespuesta()
     * @uses RespuestaBaja::setResultado()
     * @uses RespuestaBaja::setErroresValidacion()
     * @uses RespuestaBaja::setIdiomaErrores()
