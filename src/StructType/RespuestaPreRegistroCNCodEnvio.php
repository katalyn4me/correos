...
class RespuestaPreRegistroCNCodEnvio extends AbstractStructBase
{
     ...
     * @uses RespuestaPreRegistroCNCodEnvio::setIdiomaErrores()
     ...
     */
    public function __construct(?string $fechaRespuesta = null, ?string $resultado = null, ?int $totalBultos = null, ?\StructType\DATOSBULTOTYPE $bulto = null, ?\StructType\DATOSBULTOERRORTYPE $bultoError = null, ?string $idiomaErrores = null)
    {
        $this
     ...
     * @param string $fechaRespuesta
     * @return \StructType\RespuestaPreRegistroCNCodEnvio
     */
