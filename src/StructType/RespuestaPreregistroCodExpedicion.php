...
/**
 * This class stands for RespuestaPreregistroCodExpedicion StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class RespuestaPreregistroCodExpedicion extends AbstractStructBase
{
    /**
     * The CodExpedicion
    ...
    /**
     * Constructor method for RespuestaPreregistroCodExpedicion
     * @uses RespuestaPreregistroCodExpedicion::setCodExpedicion()
     * @uses RespuestaPreregistroCodExpedicion::setReferenciaExpedicion()
     * @uses RespuestaPreregistroCodExpedicion::setEntregaParcial()
     * @uses RespuestaPreregistroCodExpedicion::setFechaRespuesta()
     * @uses RespuestaPreregistroCodExpedicion::setResultado()
     * @uses RespuestaPreregistroCodExpedicion::setTotalBultos()
     * @uses RespuestaPreregistroCodExpedicion::setBulto()
     * @uses RespuestaPreregistroCodExpedicion::setBultoError()
     * @uses RespuestaPreregistroCodExpedicion::setAlertas()
     * @uses RespuestaPreregistroCodExpedicion::setIdiomaErrores()
     ...
     * @param string $codExpedicion
     * @return \StructType\RespuestaPreregistroCodExpedicion
     */
