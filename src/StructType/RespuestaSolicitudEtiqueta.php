...
class RespuestaSolicitudEtiqueta extends AbstractStructBase
{
     ...
     * @uses RespuestaSolicitudEtiqueta::setIdiomaErrores()
     ...
     */
    public function __construct(?string $codExpedicion = null, ?string $fechaRespuesta = null, ?string $resultado = null, ?int $totalBultos = null, ?\StructType\DATOSBULTOTYPE $bulto = null, ?string $idiomaErrores = null)
    {
        $this
     ...
     * @param string $codExpedicion
     * @return \StructType\RespuestaSolicitudEtiqueta
     */
