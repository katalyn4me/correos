...
class RespuestaSolicitudEtiquetaRefCli extends AbstractStructBase
{
     ...
     */
    public function __construct(?string $codExpedicion = null, ?string $fechaRespuesta = null, ?string $resultado = null, ?int $totalBultos = null, ?\StructType\DATOSBULTOTYPE $bulto = null, ?\StructType\DATOSBULTOERRORTYPE $bultoError = null, ?string $idiomaErrores = null)
    {
        $this
