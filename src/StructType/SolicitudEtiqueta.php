...
/**
 * This class stands for SolicitudEtiqueta StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class SolicitudEtiqueta extends AbstractStructBase
{
    /**
     * The FechaOperacion
     ...
     * @uses SolicitudEtiqueta::setFechaOperacion()
     * @uses SolicitudEtiqueta::setCodEtiquetador()
     * @uses SolicitudEtiqueta::setNumContrato()
     * @uses SolicitudEtiqueta::setNumCliente()
     * @uses SolicitudEtiqueta::setCodEnvio()
     * @uses SolicitudEtiqueta::setCare()
     * @uses SolicitudEtiqueta::setModDevEtiqueta()
     * @uses SolicitudEtiqueta::setIdiomaErrores()
     ...
     * @param string $fechaOperacion
     * @return \StructType\SolicitudEtiqueta
     */
